                    ...
                    <div className='py-28 w-[80%] pl-9 md:w-[50%] md:pl-32'>
                        ...
                        <ActionBtn>VIEW THE RANGE</ActionBtn>
                            ...
                            <div className='absolute xxs:left-28 flex items-center justify-center md:flex-col md:left-[1100px] md:bottom-[250px] sm:left-72'>
                            {
                                ...
                                <span key={currentState} onClick={()=> goToNext(currentState)} className='dots mt-16 w-[10px] h-[10px] bg-[#D9D9D9] ml-6 rounded-full cursor-pointer hover:bg-slate-700 active:bg-slate-700 md:w-[15px] md:h-[15px] md:mt-5'></span>
                                ))
                            }
                            </div>
                    </div>
