  ...
  return (
    <section>
        <div className='flex items-center justify-center w-5/6 mx-auto gap-6 mt-16'>
            ...
            <img src={img1} alt='image' className='w-12 sm:w-24'/>
            <img src={img2} alt='image' className='w-12 sm:w-24'/>
            <img src={img3} alt='image' className='w-12 sm:w-24'/>
            <img src={img4} alt='image' className='w-12 sm:w-24'/>
            <img src={img5} alt='image' className='w-12 sm:w-24'/>
            <img src={img6} alt='image' className='w-12 sm:w-24'/>
            <img src={img7} alt='image' className='w-12 sm:w-24'/>
