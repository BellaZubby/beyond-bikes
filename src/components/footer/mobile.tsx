...
const Mobile = () => {
    ...
    return (
        <div className='bg-black'>
            <div className='bg-black text-gray-500 w-full'>
                ...
                <div className='w-5/6 mx-auto pt-6'>
                    <div className='flex items-center justify-between'>
                        <h1 className='text-sm text-white font-robotoCondensed'>COMPANY</h1>
                        <ChevronDownIcon
            ...
            {!isAboveMediumScreens && isMenuToggled && (
                <div className='bg-black'>
                    ...
                    <div className='flex flex-col gap-2 text-sm text-gray-500 w-5/6 mx-auto'>
                        {/* menu list */}
                        <p className="text-xs font-thin mb-2 mt-4 font-Roboto">About Us</p>
            ...
            <p className='text-gray-500 text-[10px] w-5/6 mx-auto py-5 font-Roboto'>© 2023 Powered by <a href='https://push.bike/' target="_blank" className='text-primary-100'>PushRetail</a>. All Rights Reserved</p>
        </div>
    )
}
